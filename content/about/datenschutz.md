...
**fussball.de:** Auf unserer Webseite nutzen wir die sog. Widgets von fussball.de, um Statistiken und weitere Informationen über unseren Verein und zugehörige Mannschaften anzuzeigen. Um die für die Darstellung notwendigen Daten abzurufen, wird die IP-Adresse des Nutzers an den Dienstanbieter übermittelt; Dienstanbieter: DFB GmbH mit Sitz in Frankfurt/Main; Rechtsgrundlagen: Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); Website: https://fussball.de/; Datenschutzerklärung: https://www.dfb.de/datenschutzerklaerung.
